...
class Net1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, ratio, filter_list, m_blocks_list, kernel_size, stride, groups_width, n_classes, use_bn=True, use_do=True, return_softmax=False, verbose=False):
