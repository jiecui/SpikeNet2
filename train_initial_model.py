...
os.makedirs(path_chkpt, exist_ok=True)
...
model = ResNet.load_from_checkpoint(
    os.path.join(path_chkpt, "hardmine-init-v12.ckpt"),
    lr=config.LR,
...
callbacks = [
    ...
    ModelCheckpoint(dirpath=path_chkpt, filename="hardmine-init-v13", monitor="val_loss"),
]
